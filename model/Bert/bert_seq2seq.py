...
from model.Bert.bert_model import BertConfig, BertLMPredictionHead, BertModel
from model.Bert.tokenizer import Tokenizer, load_chinese_base_vocab
...
class Seq2SeqModel(nn.Module):
    ...
    def forward(self,
        ...
        logits = self.decoder(squence_out)  # 32x13x21128
    ...
    def beam_search(self,
        ...
        for step in range(self.out_max_length):
            ...
            for i_1, i_2, score in zip(indice1, indice2, hype_score):
                ...
                hype_id = output_ids[int(i_1)] + [i_2]  # 保存所有输出的序列，而不仅仅是新预测的单个字符
