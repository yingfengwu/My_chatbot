...
class QuestionClassifier:
    def __init__(self):
        ...
        #　特征词路径
        self.disease_path = os.path.join(cur_dir, 'Knowledge_graph/dict/disease.txt')
        self.department_path = os.path.join(cur_dir, 'Knowledge_graph/dict/department.txt')
        self.check_path = os.path.join(cur_dir, 'Knowledge_graph/dict/check.txt')
        self.drug_path = os.path.join(cur_dir, 'Knowledge_graph/dict/drug.txt')
        self.food_path = os.path.join(cur_dir, 'Knowledge_graph/dict/food.txt')
        self.producer_path = os.path.join(cur_dir, 'Knowledge_graph/dict/producer.txt')
        self.symptom_path = os.path.join(cur_dir, 'Knowledge_graph/dict/symptom.txt')
        self.deny_path = os.path.join(cur_dir, 'Knowledge_graph/dict/deny.txt')
        # 加载特征词
        ...
        print('embedding_model init finished ......')
